...
const data_constructions = records[0][lesson_id]
...
lesson_title.appendChild(document.createTextNode(data_constructions["lesson_name"]));

// file link
const file = document.createElement("a")
file.setAttribute("class", "btn btn-light float-end")
file.setAttribute("href", `../../files/Lesson%20${data_constructions["lesson_id"]}.%20Download.pdf`)
...
for (var i = 0; i <=2; i++) {
    ...
    t.appendChild(document.createTextNode(data_constructions["construction_table_header"][i]))
...
// console.log(data_constructions["construction_table_rows"].length)

for (var i = 0; i < data_constructions["construction_table_rows"].length; i++) {
    ...
    for (var k = 0; k <=2; k++) {
        ...
        t.appendChild(document.createTextNode(data_constructions["construction_table_rows"][i][k]))
        tr.appendChild(t)
    }
...
for (var i = 0; i < data_constructions["lesson_instructions"].length; i++) {
    abbvs.appendChild(document.createTextNode(data_constructions["lesson_instructions"][i]))
